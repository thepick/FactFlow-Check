...
The app uses a local attempt lock. A student cannot casually complete the same check again with the same name and code on the same device and browser.
...
2. Students enter their name and the teacher code.
